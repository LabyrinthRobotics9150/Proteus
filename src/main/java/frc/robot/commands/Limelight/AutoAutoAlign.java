...
public class AutoAutoAlign extends Command {
    ...
    private static TrapezoidProfile.Constraints xyconstraints = new TrapezoidProfile.Constraints(.3, 5);
            ...
            if (!doneWithInitial) {
                ...
                */
                ...
                if (initialR < 4) {
                    ...
                    outputY = yPidController.calculate(lateralError);
                    //outputRotation = rotationalPidController.calculate(Units.degreesToRadians(fiducial.txnc));
                    if (yPidController.atGoal()) {initialR += 1; System.out.println("GOAL VALUE: " + Units.degreesToRadians(fiducial.txnc));}
                }
                ...
                if (!initialY && initialR >= 4) {
                    ...
                    //outputY = yPidController.calculate(lateralError);
                    outputRotation = rotationalPidController.calculate(Units.degreesToRadians(fiducial.txnc));
                    if (rotationalPidController.atGoal()) {initialY = true;}
